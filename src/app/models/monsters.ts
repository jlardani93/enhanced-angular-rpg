...
export class Monster {
  constructor(public name: string, public level, public maxHealth: number, public maxMana: number, public defense: number, public strength: number, public intelligence: number, public dexterity: number, public luck: number, attackAttribute, public killExperience: number, public imgPath: string, ...abilities){
